...
class TmpCatViewController: UIViewController {
...
extension TmpCatViewController {
    ...
    func makeCategoryButton(){
       ...
       // chooseCategoryLabel.frame.size.width = self.view.frame.size.width - 30
        chooseCategoryLabel.centerXAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: 0).isActive = true
        ...
        if categories.count != 0 {
            for i in 0...categories.count - 1 {
                ...
                if i % 2 == 0 {
                    ...
                    button.rightAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: -10).isActive = true
                    ...
                    button.leftAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: 10).isActive = true
            ...
            departmentLabel.centerXAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: 0).isActive = true
        ...
        societyLabel.centerXAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: 0).isActive = true
        ...
        requestLabel.centerXAnchor.constraint(equalTo: categoryView.centerXAnchor, constant: 0).isActive = true
...
extension TmpCatViewController : UIPickerViewDelegate, UIPickerViewDataSource{
